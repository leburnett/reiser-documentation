...
::: {.callout-note}
### First time here?
If you haven't set up the system yet, start with the [Installation & Setup](freely_walking_installation.qmd) page for software dependencies and configuration steps.
:::
...
Please refer to the page on computer [configuration](Freely-walking/freely_walking_configuration.qmd) for detailed help on the below steps.
