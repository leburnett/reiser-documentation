...
![<b>Figure:</b> Frame from a video generated using `generate_circ_stim_ufmf` showing the stimulus, behavioural image and superimporsed fly trajectories.](../assets/imgs/freely/generate_circ_stim_ufmf.png){.ifr_center}
...
- **Path to the JAABA repository** — set this to your own JAABA checkout, e.g. `<path to>/JAABA-master`
