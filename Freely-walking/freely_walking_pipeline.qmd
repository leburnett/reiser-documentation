...
![<b>Figure: </b> ](../assets/imgs/freely/dashboard/pipeline_status1.png){.ifr_center}

![<b>Figure: </b> ](../assets/imgs/freely/dashboard/pipeline_status2.png){.ifr_center}

### What it contains

- **Sortable and filterable tables** with colour-coded pipeline stages for each experiment

![<b>Figure: </b> ](../assets/imgs/freely/dashboard/pipeline_table.png){.ifr_center}
...
![<b>Figure: </b> ](../assets/imgs/freely/dashboard/pipeline_status_protocol.png){.ifr_center}

![<b>Figure: </b> ](../assets/imgs/freely/dashboard/pipeline_status_strain.png){.ifr_center}

![<b>Figure: </b> ](../assets/imgs/freely/dashboard/pipeline_timeline.png){.ifr_center}
...
```cmd
REM on the acquisition rig:
setx MACHINE_ROLE acquisition

REM on the processing machine:
setx MACHINE_ROLE processing
```
