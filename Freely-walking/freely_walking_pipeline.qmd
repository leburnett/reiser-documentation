...
The processing pipeline generates a standalone HTML page that shows the current processing stage of every experiment. It is auto-regenerated whenever the pipeline updates an experiment's status. You can view it here: `reiserlab/oaky-cokey/pipeline_status.html`.
:::
