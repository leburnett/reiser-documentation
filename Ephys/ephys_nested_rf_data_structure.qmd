...
- **Protocol 2 data:** Located in a dedicated `data/` subfolder (organized by experiment type and condition)
...
Protocol 2 data is stored in `nested_RF_stimulus/protocol2/data/`, organized by experiment campaign and condition.
...
Contains the randomized order in which stimuli were presented during the experiment.

### processedData.mat

Contains processed analysis results including:
- Extracted spike times or membrane potential traces
...
### By Date
- **Protocol 1:** Look for date folders (MM_DD_YYYY) within the appropriate protocol version folder
- **Protocol 2:** Experiment folders are named with timestamps (YYYY_MM_DD_HH_MM)

### By Strain/Genotype
- **Protocol 1:** Strain is encoded in the experiment folder name (e.g., `42F06XJFRC28_T4T5-15_29_81`)
- **Protocol 2:** Navigate to the appropriate experiment category folder (e.g., `DS_v2/TmY3/`)

### By Condition (Drug/Treatment)
- **Protocol 2 only:** Navigate to condition subfolders (e.g., `Octopamine/pre/`, `RNAi_ttl_2025/control/`)

### By Contrast (ON/OFF)
- **Protocol 2:** Some experiment folders have ON/OFF subfolders indicating which contrast was presented
