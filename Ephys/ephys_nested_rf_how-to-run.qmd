...
::: {.callout-tip}
A detailed explanation of Protocol 1 can be found [here](ephys_nested_rf_protocol1.qmd).
:::
...
::: {.callout-tip}
A detailed explanation of Protocol 2 can be found [here](ephys_nested_rf_protocol2.qmd).
:::
