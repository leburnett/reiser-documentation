...
**Solution:** Install the Circular Statistics Toolbox from the MATLAB Add-On Explorer. See [Getting Started](ephys_nested_rf_getting-started.qmd).

### Hardcoded path errors

**Symptom:** File not found errors referencing `C:\matlabroot\...` or `/Users/burnettl/...`.

**Solution:** Several files contain hardcoded paths specific to the original rig. Update them for your system — see the [hardcoded paths table](ephys_nested_rf_getting-started.qmd#hardcoded-paths-to-update) in Getting Started.
