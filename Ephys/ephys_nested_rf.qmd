...
- Multi-step protocol consisting of a <b>short first protocol (P1)</b> that determines the rough receptive field location and preferred contrast of the cell, and a <b>longer second protocol (P2)</b> that is only presented within a subsection of the arena screen, centred on the location of the peak response determined in P1.
...
- P1 is run through the `G4_experiment_conductor` [GUI](/resources.qmd#g4-software)
