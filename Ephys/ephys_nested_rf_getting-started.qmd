...
This page covers the full installation and configuration process for the Nested RF Protocol. For a brief prerequisites checklist, see the [Quickstart](ephys_nested_rf.qmd) page. For details on the physical rig setup and arena specifications, see the [Rig Specs](ephys_rig_specs.qmd) page.
...
| `src/analysis/process_protocol2.m` | 45 | `<data_root>/protocol2` | `PROJECT_ROOT` — where analysis results and figures are saved |
: {.bordered}
...
Refer to the [G4 Software](/resources.qmd#g4-software) documentation for detailed configuration instructions.
