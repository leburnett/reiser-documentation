...
Documentation for the freely-walking optomotor experiments is generated from the [freely-walking-optomotor](https://github.com/leburnett/freely-walking-optomotor) repository and published under the `Freely-walking/` section of the site.
...
See the [freely-walking-optomotor README](https://github.com/leburnett/freely-walking-optomotor#9-dashboard) for setup instructions.
...
This page is auto-regenerated by the processing machine whenever an experiment's pipeline status changes.
